        ...
        foreach ($result as $row) {
            ...
            echo "
                ...
                relativeAlert($fName, $lName, $cnxn). clientAlert($SFName, $SLName, $cnxn). " " . spouseAlert($SFName, $SLName, $cnxn). " " . relativeAlert($SFName, $SLName, $cnxn). "</td>
                    <td><a href='Pending_Clients/add-purgatory.php?save=on&ID=$clientID'>Save</a></td>
                    <td><a href='Pending_Clients/add-purgatory.php?delete=on&ID=$clientID' onclick='return confirm(\"Are you sure?\")'>Delete</a></td>
                </tr>";
        }
        ?>
        </tbody>
