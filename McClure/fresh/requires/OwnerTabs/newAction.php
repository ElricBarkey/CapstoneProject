...
if(!empty($_GET['actionID']) && (!empty($_GET['delete']))){
    ...
    //var_dump($row);
    //Get the data from the row
    header("location: http://bhalbert2.greenriverdev.com/CapstoneProject/McClure/fresh/index.php?&ownerTab=action");
    ...
    <form id="student-form" action=<?php echo $url ?> method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"
                   id="actionID" name="actionID" value="<?php echo $actionID ?>">
        </div>
        <div class="form-group">
