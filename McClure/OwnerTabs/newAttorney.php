...
if(isset($_GET['attorneyID'])){
    $_SESSION['attorneyID'] = $_GET['attorneyID'];
    echo $_SESSION['attorneyID'];
}

//See if this is an edit
if(!empty($_GET['attorneyID']) && (!empty($_GET['edit']))){
...
if(!empty($_GET['attorneyID']) && (!empty($_GET['delete']))){
    ...
    //Get the data from the row
    header("location: https://bhalbert2.greenriverdev.com/CapstoneProject/McClure/index.php?&ownerTab=attorneys");
...
<div class="container">
    ...
    <a href="https://bhalbert2.greenriverdev.com/CapstoneProject/McClure/index.php?&ownerTab=attorney">View attorney</a>
</div>
