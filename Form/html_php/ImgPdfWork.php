...
<head>
    ...
    <link href="../../../PDF-Conversion-NEW/Form/css/FileUpload.css" rel="stylesheet">
</head>
<body>
<?php
...
<form action="" method="post" enctype="multipart/form-data" id="form" class="text-center">
    ...
    <button type="submit" name="submit" id="submit" onclick="myFunction()">Upload</button>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($filesArr as $position => $imagefile) {
        if (isset($imagefile)&& $_FILES["photo"]["name"][$position]!=null) {
            ...
            $ilovepdf = new Ilovepdf('project_public_fef60e15c9065214bf528ba5358c39d3_jX5mb4b3799f16f164a8ea8b4a77dfae31f13', 'secret_key_11bfdb952d4a685f1440b972fe7d86fd_ZjlCZ475f8b6e1f5a6311019f46ee2e5a710a');
