  ...
  <form id="myForm" action="confirmForm.php" method="post">
    ...
    <fieldset class="form-group">
      ...
      <div class="form-group">
        ...
        <input placeholder="Your Date of Birth (required) dd/mm/yyyy" type="date" class="form-control" id="DOB" name="DOB" >
      ...
      <div id="hidden">
        <div class="form-group">
          ...
          <input placeholder="Spouse Date of Birth" type="date" class="form-control" id="sDOB" name="sDOB" >
