...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($filesArr as $position => $imagefile) {
        if (isset($imagefile)&& $_FILES["photo"]["name"][$position]!=null) {
            ...
            $ilovepdf = new Ilovepdf('project_public_da32d0b36465858e4cd409d324a0e2af_x4qtYb4c21fca65f3d68d5ef96f3b8df71f92'
                , 'secret_key_46a727f3c1e53eaa8bcf3338d9492de6_BNJ9v2fd78f1998ab0e938b5bb40e55b58223');
            ...
            $path2 = '../TempFileHolder/' . $filename2;
            $path = "/upload/" . $filename2;
            $fp = fopen($path2, 'rb');
            $size = filesize($path2);

            $cheaders = array('Authorization: Bearer l3w8wpf6sJMAAAAAAAAAAflPmcMpLqta2sXVJ6S7jWHjZIl3bYahl3d3NYavV1d6',
